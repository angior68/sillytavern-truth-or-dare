...
class TruthOrDareExtension {
    ...
    async #loadGameData() {
        try {
            ...
            const truthsResponse = await fetch('/scripts/extensions/sillytavern-truth-or-dare/truths.json');
            ...
            // THIS IS THE CORRECTED PATH
            const daresResponse = await fetch('/scripts/extensions/sillytavern-truth-or-dare/dares.json');
